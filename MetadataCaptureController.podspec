#
# Be sure to run `pod lib lint MetadataCaptureController.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/MetadataCaptureController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Pietro Caselani' => 'pietro.caselani@involves.com.br' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/MetadataCaptureController.git', :tag => s.version.to_s }
